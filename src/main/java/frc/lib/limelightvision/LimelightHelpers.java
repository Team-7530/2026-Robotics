...
public class LimelightHelpers {
    ...
    /**
     * Helper that reads a botpose entry (e.g. "botpose_orb_wpiblue") and
     * converts the raw array into a {@link PoseEstimate}.  This method was
     * previously private but our robot code relies on it directly; making it
     * public avoids duplicating the parsing logic in multiple locations.
     */
